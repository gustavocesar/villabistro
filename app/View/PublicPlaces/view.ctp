<div class="row">
    <div class="col-lg-12">
		...
		<td class="col-lg-9">
			<?php echo h($publicPlace['PublicPlace']['id']); ?>
		</td>
		</tr>
		<tr>
		<td class="col-lg-3"><?php echo __('Name'); ?></td>
		<td class="col-lg-9">
			<?php echo h($publicPlace['PublicPlace']['name']); ?>
		</td>
		</tr>
		<tr>
		<td class="col-lg-3"><?php echo __('Created'); ?></td>
		<td class="col-lg-9">
			<?php echo h(date(Configure::read('ShowDateTimeFormat'), strtotime($publicPlace['PublicPlace']['created']))); ?>
		</td>
		</tr>
		<tr>
		<td class="col-lg-3"><?php echo __('Modified'); ?></td>
		<td class="col-lg-9">
			<?php echo h(date(Configure::read('ShowDateTimeFormat'), strtotime($publicPlace['PublicPlace']['modified']))); ?>
		</td>
		</tr>
                    </tbody>
                </table>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-violet">
                ...
                <div class="panel-body">
                    <?php if (!empty($publicPlace['Address'])): ?>
                    <table class="table table-hover">
                        <tr>
		...
		<th><?php echo __('Modified'); ?></th>
                        	...
                        	<?php foreach ($publicPlace['Address'] as $address): ?>
		<tr>
