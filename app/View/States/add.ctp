<div class="panel panel-blue" style="background:#fff;">
    ...
    <div class="panel-body pan">
        <?php echo $this->Form->create('State', ['inputDefaults'=>['error'=>['attributes'=>['class'=>'alert alert-danger custom-required']]]]); ?>
		...
		<div class="form-group">
		<?php echo $this->Form->input('uf', ['class'=>'form-control', 'div'=>false, 'label'=>['class'=>'control-label']]); ?>
		</div>
