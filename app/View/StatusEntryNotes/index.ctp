            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($statusEntryNotes as $statusEntryNote): ?>
                                <tr>
                                    <td class="text-center">
                                        <?php
                                        echo $this->Html->link(
                                                '<i class="fa fa-check"></i>', [
                                            'controller' => 'statusEntryNotes',
                                            'action' => 'view',
                                            $statusEntryNote['StatusEntryNote']['id']
                                        ...
                                        echo $this->Form->postLink(
                                            ...
                                            'escape' => false,
                                            'title' => __('Delete'),
                                            'confirm' => __('Are you sure you want to delete # %s?', $statusEntryNote['StatusEntryNote']['id'])
                                                ]
                                        );
                                        ?>
                                    </td>
                                    <td><?php echo h($statusEntryNote['StatusEntryNote']['id']); ?></td>
                                    <td><?php echo h($statusEntryNote['StatusEntryNote']['name']); ?></td>
                                    <td><?php echo h($statusEntryNote['StatusEntryNote']['finish']); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
