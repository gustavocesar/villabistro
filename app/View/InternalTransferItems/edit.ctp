...
<div class="modal-body">
    ...
    <div class="form-group">
        <?php echo $this->Form->input('internal_transfer_id', ['type' => 'hidden', 'class' => 'form-control', 'div' => false, 'label' => ['class' => 'control-label']]); ?>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        echo $this->Form->input('quantity', [
            'label' => false,
            'class' => 'form-control',
            'value' => $InternalTransferItem['InternalTransferItem']['quantity'] ? number_format($InternalTransferItem['InternalTransferItem']['quantity'], 3, ',', '.') : "",
            'type' => 'text',
