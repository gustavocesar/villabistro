<div class="panel panel-blue" style="background:#fff;">
    ...
    <div class="panel-body pan">
        ...
        <div class="form-body pal">
            ...
            <div class="form-group">
                <?php echo $this->Form->input('phone', ['class' => 'form-control', 'placeholder'=>'(xx) xxxx-xxxx', 'div' => false, 'label' => ['class' => 'control-label']]); ?>
            </div>
            <div class="form-group">
                <?php echo $this->Form->input('fax', ['class' => 'form-control', 'placeholder'=>'(xx) xxxx-xxxx', 'div' => false, 'label' => ['class' => 'control-label']]); ?>
            </div>
            <div class="form-group">
