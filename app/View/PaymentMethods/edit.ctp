<div class="panel panel-blue" style="background:#fff;">
    ...
    <div class="panel-body pan">
        <?php echo $this->Form->create('PaymentMethod', ['inputDefaults'=>['error'=>['attributes'=>['class'=>'alert alert-danger custom-required']]]]); ?>
		...
		<div class="form-group">
		<?php echo $this->Form->input('status_payment_method_id', ['class'=>'form-control', 'div'=>false, 'label'=>['class'=>'control-label']]); ?>
		</div>
		<div class="form-group">
		<?php echo $this->Form->input('sequence', ['class'=>'form-control', 'div'=>false, 'label'=>['class'=>'control-label']]); ?>
		</div>
