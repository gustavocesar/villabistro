                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($group['User'] as $user): ?>
                                <tr>
                                    ...
                                    <td><?php echo h(date(Configure::read('ShowDateTimeFormat'), strtotime($user['created']))); ?></td>
                                    <td><?php echo h(date(Configure::read('ShowDateTimeFormat'), strtotime($user['modified']))); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                    </div>
