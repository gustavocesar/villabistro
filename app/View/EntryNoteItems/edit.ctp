...
<div class="modal-body">
    ...
    <div class="form-group">
        <?php echo $this->Form->input('entry_note_id', ['type' => 'hidden', 'class' => 'form-control', 'div' => false, 'label' => ['class' => 'control-label']]); ?>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        echo $this->Form->input('quantity', [
            'label' => false,
            'class' => 'form-control',
            'value' => $EntryNoteItem['EntryNoteItem']['quantity'] ? number_format($EntryNoteItem['EntryNoteItem']['quantity'], 3, ',', '.') : "",
            'type' => 'text',
    ...
    <div class="form-group">
        ...
        echo $this->Form->input('unit_cost', [
            'label' => false,
            'class' => 'form-control',
            'value' => $EntryNoteItem['EntryNoteItem']['unit_cost'] ? number_format($EntryNoteItem['EntryNoteItem']['unit_cost'], 3, ',', '.') : "",
            'type' => 'text',
            'div' => ['class' => 'input-group'],
    ...
    <div class="form-group">
        ...
        echo $this->Form->input('total_cost', [
            'label' => false,
            'class' => 'form-control',
            'value' => $EntryNoteItem['EntryNoteItem']['total_cost'] ? number_format($EntryNoteItem['EntryNoteItem']['total_cost'], 3, ',', '.') : "",
            'type' => 'text',
            'div' => ['class' => 'input-group'],
            'between' => '<div class="input-group-addon">R$</div>'
        ]);
