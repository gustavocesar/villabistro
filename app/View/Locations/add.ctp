<div class="panel panel-blue" style="background:#fff;">
    ...
    <div class="panel-body pan">
        <?php echo $this->Form->create('Location', ['inputDefaults'=>['error'=>['attributes'=>['class'=>'alert alert-danger custom-required']]]]); ?>
		...
		<div class="form-group">
                    <?php echo $this->Form->input('location_type_id', ['class'=>'form-control', 'div'=>false, 'disabled'=>'disabled', 'label'=>['class'=>'control-label']]); ?>
		</div>
